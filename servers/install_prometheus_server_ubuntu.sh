...
# Tested on Ubuntu 22.04, 17.09
# Developed by Yuriy Orishchak in 2024
#--------------------------------------------------------------------

RELEASES_URL="https://github.com/prometheus/prometheus/releases/latest"
PROMETHEUS_VERSION=$(curl -sI $RELEASES_URL | grep -oP 'releases/tag/v\K[0-9]+\.[0-9]+\.[0-9]+')
...
EOF
    ...
    echo "Cannot find Prometheus release version, exit!"
fi
